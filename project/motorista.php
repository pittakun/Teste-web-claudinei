                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($value->status == 'inativo'){
                            echo "<a href='processa.php?acao=editar&id=" . $value->id_motorista . "&status=" . $value->status . "'>Ativar</a>"; }
                        else {echo "<a href='processa.php?acao=editar&id=" . $value->id_motorista . "&status=" . $value->status . "'>Desativar</a>"; }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="cpf" value="" placeholder="CPF" class="inp" />
                        <input type="text" name="carro" value="" placeholder="Modelo do Carro" class="inp" /><br />
                        <div class="rad">
                    ...
                    <div class="modal-footer">
                        <input type="submit" name="cadastrar-motorista" class="btn btn-primary" value="Cadastrar dados">
    </form>
